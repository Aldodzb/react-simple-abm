...
const CompanyForm = ({
  ...
  function handleModify() {
    onActions.handleModify(tempUser.rut, userData2);
  }
  ...
  return (
    ...
    >
      <TextField
        ...
        value={userData2.rut}
        onChange={handleChange("rut")} //(userData.username = tempUser.username)}
        margin="normal"
      />
      <TextField
        id="standard-name"
      ...
      <TextField
        ...
        label="Commission"
        className={classes.textField}
        value={userData2.commission}
        onChange={handleChange("commission")}
        margin="normal"
      />
      <TextField
        id="standard-name"
        label="Cmmission Percentage"
        className={classes.textField}
        value={userData2.percentageCommission}
